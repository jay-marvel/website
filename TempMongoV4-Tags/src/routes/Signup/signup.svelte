...
<form bind:this={thisForm} use:enhance method="post" action="?/signup">
    ...
    <div class="form-item">
        ...
        <input value={form?.lastNameName?? ''} id="lastName" type="text" name ="lastName" required />
    ...
    <div class="form-item">
        ...
        <input class:fieldError={form?.weakPasdsword} id="password" type="password" name ="password" required />
